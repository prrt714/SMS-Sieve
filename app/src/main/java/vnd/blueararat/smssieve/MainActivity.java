...
public class MainActivity extends FragmentActivity {
    ...
    private static final int READ_SMS_PERMISSION_RESULT = 3;
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode) {
            case READ_SMS_PERMISSION_RESULT: {
    ...
    public List<String> getAddresses() {
        ...
        final String[] projection = new String[]{Telephony.Sms.ADDRESS};
        Cursor cursor = getContentResolver().query(Telephony.Sms.Inbox.CONTENT_URI, projection, null, null, null);
        ...
        result.addAll(set);
        Collections.sort(result, (a, b) -> b.toLowerCase().compareTo(a.toLowerCase()));
        return result;
    }
        ...
        switch (item.getItemId()) {
            ...
            case R.id.export:
                ...
                Intent shareIntent = ShareCompat.IntentBuilder.from(this)
                        ...
                        .setSubject(getString(R.string.subject)).createChooserIntent();
